...
@section('content')
    ...
    <body>
        <br>
        <br>
        <h1 class="text-center mb-5 mt-5">Tambah Data Penyelenggara</h1>
                        ...
                        <div class="card-body">
                            <form action="/insertdatadetail" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="instansi" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Bidang</label>
                                    <input type="text" name="bidang" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
